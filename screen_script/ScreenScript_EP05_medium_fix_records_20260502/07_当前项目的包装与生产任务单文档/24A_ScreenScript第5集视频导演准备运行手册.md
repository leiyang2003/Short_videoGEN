...
python3 scripts/run_novel_video_director.py \
  --bundle screen_script/ScreenScript_EP05_medium_fix_records_20260502 \
  --episode EP05 \
...
- 角色参考图来自 `screen_script/ScreenScript_EP05_medium_fix_records_20260502_input/character_image_map.json`。
