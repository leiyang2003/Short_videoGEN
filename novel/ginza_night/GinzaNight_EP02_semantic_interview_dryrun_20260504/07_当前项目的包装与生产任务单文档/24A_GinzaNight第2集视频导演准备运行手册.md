...
python3 scripts/run_novel_video_director.py \
  --bundle novel/ginza_night/GinzaNight_EP02_semantic_interview_dryrun_20260504 \
  --episode EP02 \
  --experiment-prefix ginzanight_ep02_director \
  --provider openai \
  --allow-data-uri-from-local \
  --enable-high-confidence-shot-chaining \
  --shots SH01,SH02,SH03,SH04,SH05,SH06,SH07,SH08,SH09,SH10,SH11,SH12
```
...
- 角色参考图来自 `novel/ginza_night/GinzaNight_EP02_rerun_20260502_from_scratch_v2/03_当前项目的原始输入文档/character_image_map.json`。
...
test/ginzanight_ep02_director_shot_chain_plan.json
