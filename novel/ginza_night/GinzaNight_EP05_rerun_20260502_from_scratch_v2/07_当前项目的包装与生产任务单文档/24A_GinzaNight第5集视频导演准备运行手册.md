...
python3 scripts/run_novel_video_director.py \
  --bundle novel/ginza_night/GinzaNight_EP05_rerun_20260502_from_scratch_v2 \
  --episode EP05 \
  --experiment-prefix ginzanight_ep05_director \
  --provider openai \
...
python3 scripts/run_novel_video_director.py \
  --bundle novel/ginza_night/GinzaNight_EP05_rerun_20260502_from_scratch_v2 \
  --episode EP05 \
  --experiment-prefix ginzanight_ep05_director_check \
  --provider openai \
  --allow-data-uri-from-local \
  --prepare-only \
  --enable-high-confidence-shot-chaining \
...
## 主要输出
```text
test/ginzanight_ep05_director_language/language/duration_overrides.json
test/ginzanight_ep05_director_language/language/language_plan.json
test/ginzanight_ep05_director_keyframes/keyframe_manifest.json
test/ginzanight_ep05_director_keyframes/image_input_map.json
test/ginzanight_ep05_director_shot_chain_plan.json
test/ginzanight_ep05_director_director_manifest.json
```
