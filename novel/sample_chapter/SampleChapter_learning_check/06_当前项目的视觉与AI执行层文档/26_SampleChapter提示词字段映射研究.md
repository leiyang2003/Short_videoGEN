# SampleChapter提示词字段映射研究

> 项目标题：猎物觉醒（1-8章）

## 字段映射
- project_meta：来自短剧总纲、20集分集大纲、第1集封面标题测试包。
- emotion_arc：来自适配诊断、第1集镜头脚本。
- character_anchor：来自人物关系与角色卡、角色统一视觉设定包。
- scene_anchor：来自视觉风格与分镜方案、场景出图清单。
- shot_execution：来自第1集镜头脚本和Seedance逐镜头执行表。
- dialogue_language：来自第1集剧本和旁白字幕稿。
